...
func init(line_id: int, display_text: String, line_color: Color) -> void:
	_line_id = line_id
	_display_text = display_text
	_line_color = line_color


func update(line_id: int, display_text: String, line_color: Color) -> void:
	_line_id = line_id
	_display_text = display_text
	_line_color = line_color
	_ready()
