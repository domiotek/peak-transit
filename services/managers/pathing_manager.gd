...
func find_path(start_node_id: int, end_node_id: int, callback: Callable, force_start_endpoint: int = -1, force_end_endpoint: int = -1) -> void:
	...
	path_finder.FindPath(start_node_id, end_node_id, request_id, Callable(self, "_on_pathfinding_result"), force_start_endpoint, force_end_endpoint, 0)


func find_path_with_multiple_options(combinations: Array, callback: Callable, timeout: float = 50.0) -> void:
