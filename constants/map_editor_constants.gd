...
const MAP_NET_ROADSIDE_OBJECT_LAYER_ID = (1 << 7) # 8 layer
const MAP_ALL_DETECTABLE_LAYERS = MAP_NET_NODE_LAYER_ID | MAP_NET_SEGMENT_LAYER_ID | MAP_NET_LANE_LAYER_ID | MAP_NET_ROADSIDE_OBJECT_LAYER_ID
